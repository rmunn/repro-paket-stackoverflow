...
[<assembly: AssemblyTitleAttribute("NewProj.Tests")>]
[<assembly: AssemblyProductAttribute("NewProj")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "NewProj.Tests"
    let [<Literal>] AssemblyProduct = "NewProj"
